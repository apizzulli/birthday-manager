...
export default function BirthdayModal({toggle}) {
    const [birthdayCreated, setBirthdayCreated] = useState(false);
    return(   
        <div class="modal-wrapper">
            <div style={{width:'100%', overflow:'auto'}}><CancelIcon onClick={()=> toggle(false)} style={{float:'right', marginRight:'5px',marginTop:'5px'}}></CancelIcon> </div>
